...
public class DBSearchRest extends Connector implements DBSearch {
    ...
    private static final Pattern PIDPATTERN = Pattern.compile(
            Pattern.quote("<pid>")
                    + "([^<]*)"
                    + Pattern.quote("</pid>"));
    ...
    public DBSearchRest(Credentials creds, String location)
    ...
    public List<String> findObjectFromDCIdentifier(String identifier)
        ...
        WebResource query = restApi.queryParam("pid", "true")
